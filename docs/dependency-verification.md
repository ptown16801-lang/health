...
| Hashing, manifests, command capture, reporting | Python standard library | Python 3.12.11 tested; project requires Python 3.11+ | PSF-2.0 | Local Python installation | None |
...
- PyPI metadata for `onenote-tool` 0.1.5 declares Python 3.10+; this project requires Python 3.11+, MIT, `pyOneNote==0.0.2`, Pillow 10+, and cryptography 44+. The upstream `0.1.5` tag resolves to the commit recorded above.
